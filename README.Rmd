...
```
```{r, echo = FALSE}
embed_png("vignettes/inflation.png")
```
...
```
```{r, echo = FALSE}
embed_png("vignettes/pop.png")
```
<!-- ![](vignettes/pop.png) -->

### Population by departement

```{r population_departement, eval=FALSE}
library(insee)
library(tidyverse)
...
```
```{r, echo = FALSE}
embed_png("vignettes/pop_map.png")
```
